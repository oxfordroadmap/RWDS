---
title: "A Christmas card in R for the Global Business Services Today community"
description: |
  Inspired by Nicola Rennie's excellent tutorial on making Christmas cards with R, we've had a go at putting together our own design -- especially for you, the wonderful community of Global Business Services Today readers and contributors. Thank you for supporting us this year!
categories:
  - R
  - Data visualisation
  - Updates
...
If you missed the Meetup session, Nicola has kindly written [a tutorial for Global Business Services Today](/applied-insights/tutorials/posts/2023/12/12/xmas-cards.qmd) that walks through all the necessary steps to create a snowman against a snowy night's sky. You'll want to read that tutorial first before returning to this blog.

My design uses the same basic setting as Nicola's but updates the scene to reflect the Global Business Services Today (RWDS) brand colours, and I replace the snowman with a Christmas tree adorned with coloured baubles.
...
![](images/rwds-christmas-card.png){fig-align="center" fig-alt="Purple square with white snowflakes and green tree in foreground. Tree is decorated with red and gold baubles of various sizes. Text over tree reads Merry Christmas. Under tree is a logo for the Global Business Services Today website."}

I hope you like the Christmas card! From all of us at Global Business Services Today, thank you for your support throughout 2023. Merry Christmas, happy holidays, and best wishes for 2024!
...
::: {.g-col-12 .g-col-md-6}
How to cite
: Tarran, Brian. 2023. "A Christmas card in R for the Global Business Services Today community." Global Business Services Today, December 12, 2023. [URL](https://gbs.today/global-pulse/editors-blog/posts/2023/12/12/rwds-xmas-card.html)
:::
:::
:::