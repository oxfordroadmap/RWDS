...
description: |
  Global Business Services Today interviews UK national statistician Professor Sir Ian Diamond about culture change and innovation in the national statistical system post-Covid, building trust through transparency, and using AI tools to empower people to interrogate data.
categories:
  - Data
  - People
  - Innovation
...
aliases: 
  ...
  - /global-pulse/interviews/posts/2023/12/15/ian-diamond.html
---
...
**I imagine, though, that when you're dealing with something like national statistics, you need to be very alive to the danger of [the hallucination problem in large language models](https://gbs.today/global-pulse/editors-blog/posts/2022/11/23/LLM-content-warning.html#qa); that if you're querying something, it doesn't throw up an invented statistic?**\
...
::: {.g-col-12 .g-col-md-6}
How to cite
: Tarran, Brian. 2023. "'I was pretty clear in my mind that we were into a no-going-back situation.'" Global Business Services Today, December 15, 2023. [URL](https://realworlddatascience.net/foundation-frontiers/interviews/posts/2023/12/15/ian-diamond.html)
:::
:::
:::